...
import * as db from '@/lib/db'; // Import nowej warstwy danych
...
export async function updateComment(formData: FormData) {
    // Ta funkcja nie jest objęta refaktoryzacją w tym kroku,
    // ale powinna zostać zaktualizowana w przyszłości.
...
export async function toggleCommentVote(formData: FormData) {
    ...
    try {
        const result = await db.toggleCommentLike(commentId, currentUser.id, voteType);
